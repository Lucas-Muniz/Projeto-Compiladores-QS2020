...
public abstract class AbstractExpression implements IsiTypes{
	...
	public abstract void checkElement(String elem, int type);
	
	
	public boolean isComplete() {
		if (operator != null && firstComplete && secondComplete) {
			return true;
			//throw new IsiSemanticException("OPERATION TYPE ERROR: operation '"+operator+"' applied to '"
	...
	public void checkParentheses() {
		if (openedParentheses != 0) {
			...
			/*throw new IsiSemanticException("EXPRESSION ERROR: bad expression formation. "+msg+" exp: "+
					firstTerm.getContent()+operator+secondTerm.getContent()); */
		}
	}
